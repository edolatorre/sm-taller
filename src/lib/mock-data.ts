...
export const repuestosIniciales: Repuesto[] = [
  {
    ...
    descripcion: "Cadena tren de rodaje",
    marca: "Komatsu",
    categoria: "tren_rodaje",
    stock: 4,
    stockMinimo: 2,
    ubicacion: "Bodega A - Estante 3",
    costoUnitario: 850000,
    proveedor: "Komatsu Chile",
    createdAt: "2025-11-05",
  },
  {
    id: "rep2",
    nroParte: "KMT-TR-2091",
    descripcion: "Zapata tren de rodaje (juego)",
    marca: "Komatsu",
    categoria: "tren_rodaje",
    stock: 6,
    stockMinimo: 4,
  ...
  {
    id: "rep3",
    nroParte: "KMT-RD-3350",
    descripcion: "Rodillo inferior",
    marca: "Komatsu",
    categoria: "tren_rodaje",
    stock: 1,
    stockMinimo: 2,
    ubicacion: "Bodega A - Estante 4",
    costoUnitario: 410000,
    proveedor: "Komatsu Chile",
    createdAt: "2025-11-05",
  },
  {
    id: "rep4",
    nroParte: "CAT-D6T-TRX",
    descripcion: "Transmisión completa reconstruida",
    marca: "Caterpillar",
    categoria: "transmision",
    stock: 1,
    stockMinimo: 1,
    ubicacion: "Bodega B - Piso",
    costoUnitario: 4200000,
    proveedor: "Finning Chile",
    createdAt: "2025-12-10",
  },
  {
    id: "rep5",
    nroParte: "CAT-D6T-KEM",
    descripcion: "Kit embrague transmisión",
    marca: "Caterpillar",
    categoria: "transmision",
    stock: 3,
    stockMinimo: 2,
    ubicacion: "Bodega B - Piso",
    costoUnitario: 680000,
    proveedor: "Finning Chile",
    createdAt: "2025-12-10",
  },
  {
  ...
  },
  {
    id: "rep7",
    nroParte: "CAT-789012",
    descripcion: "Kit sellos cilindro",
    marca: "Caterpillar",
    categoria: "hidraulico",
    stock: 5,
    stockMinimo: 3,
  ...
  {
    id: "rep8",
    nroParte: "ISZ-RC-7710",
    descripcion: "Kit rectificación cilindros",
    marca: "Isuzu",
    categoria: "motor",
    stock: 0,
    stockMinimo: 1,
    ubicacion: "Bodega C - Estante 2",
    costoUnitario: 1580000,
  ...
  },
  {
    ...
    costoUnitario: 28000,
    proveedor: "Volvo CE Chile",
    createdAt: "2026-01-15",
  },
  {
    id: "rep10",
    nroParte: "JCB-EL-1290",
    descripcion: "Sensor de presión hidráulica",
    marca: "JCB",
    categoria: "electrico",
    stock: 3,
    stockMinimo: 2,
    ubicacion: "Bodega C - Estante 6",
...
export const asignacionesRepuestoIniciales: AsignacionRepuesto[] = [
  ...
  // listo para continuar a Reparación en Proceso.
  {
    ...
    proveedor: "Finning Chile",
    notas: "Enviada desde bodega central Santiago",
  },
  {
    id: "asgrep2",
    repuestoId: "rep5",
    ...
    estado: "recibido",
    fechaSolicitud: "2026-03-01",
    fechaRecepcion: "2026-03-06",
    proveedor: "Finning Chile",
    notas: "",
  },
  // e2 - Komatsu PC200-8 (espera_repuestos): aún falta el rodillo inferior,
  // importado y en tránsito.
  {
    id: "asgrep3",
    repuestoId: "rep1",
    equipoId: "e2",
  ...
  },
  {
    ...
    fechaRecepcion: "",
    proveedor: "Komatsu Chile",
    notas: "Importado, llega en barco — ETA 2026-03-15",
  },
  // e1 - Caterpillar 320D (reparacion): bomba hidráulica ya instalada.
  {
    id: "asgrep6",
    repuestoId: "rep6",
    equipoId: "e1",
    ...
    proveedor: "Finning Chile",
    notas: "Instalada y probada",
  },
  // e4 - Hitachi ZX200-5 (reparacion): kit de rectificación recién solicitado.
  {
    id: "asgrep7",
    repuestoId: "rep8",
    equipoId: "e4",
